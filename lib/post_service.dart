...
class PostService {
  ...
  Future<Post> getOnePost() async {
    ...
    // There's no way to get these error messages to the UI if  we use try catch on future builder.
    //future builder handels errors by itself so remove try catch
    try {
